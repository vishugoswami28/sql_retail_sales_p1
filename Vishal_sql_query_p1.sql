...
-- Total Sales: How many sales transactions are recorded in the dataset?
SELECT COUNT(*) as total_sale FROM retail_sales;

-- Unique Customers: How many distinct customers are included?
SELECT COUNT (DISTINCT customer_id) as unique_customer FROM retail_sales;

-- Product Categories: How many unique product categories are represented?
